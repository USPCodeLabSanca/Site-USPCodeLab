      ...
      <div className='relative w-full px-0 py-0 bg-grayBackground'>
        <div className='w-full flex flex-col items-center py-10 text-textLightGrey font-poppins'>
          ...
          <div className='flex flex-row py-2 justify-between gap-4'>
            <Icon style='w-10 sm:w-14' Image={YoutubeIcon} alt='Icone Youtube' link='http://www.youtube.com/@uspcodelabsaocarlos1316'></Icon>
            <Icon style='w-10 sm:w-14' Image={InstagramIcon} alt='Icone Instagram' link='https://www.instagram.com/uspcodelabsanca/'></Icon>
            <Icon style='w-10 sm:w-14' Image={TelegramIcon} alt='Icone Telegram' link='https://t.me/uspcodelabsaocarlos'></Icon>
          </div>
        </div>
