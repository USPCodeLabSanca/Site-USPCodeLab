    ...
    <>
        <div className='w-full px-0 py-0 bg-grayBackground'>
            <div className='w-full flex flex-col items-center py-10 text-textLightGrey font-poppins '>
                <div className='font-bold text-3xl'>Embarque conosco!</div>
                <div className='text-lg'>Fique conectado com o Codelab!</div>
                <div className='flex flex-row py-2 justify-between gap-4'>
                    <Icon style='w-14' Image={YoutubeIcon} alt='Icone Youtube'></Icon>
                    <Icon style='w-14' Image={InstagramIcon} alt='Icone Instagram'></Icon>
                    <Icon style='w-14' Image={TelegramIcon} alt='Icone Telegram'></Icon>
                </div>
            </div>
