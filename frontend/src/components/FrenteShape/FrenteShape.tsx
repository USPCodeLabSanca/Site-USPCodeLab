...
function FrenteShape({ type, orientation }: FrenteShapeProps) {
  ...
  return (
    <div className="w-full flex items-center justify-center">
        <img src={Shape.toString()} alt="Shape" className={`${orientation === 'left' ? '-translate-x-[10rem] sm:-translate-x-[20rem] md:-translate-x-[25rem] lg:-translate-x-[36rem]' : 'translate-x-[10rem] sm:translate-x-[20rem] md:translate-x-[25rem] lg:translate-x-[36rem]'} h-[50rem] transform`}/> 
    </div>
  );
}
