...
let obj = {
  ...
  imgXLeft: [-125, -125, 0, 10, 0],
  imgXRight: [-500, 125, 10, 0, 0],
}
...
const WhoAreWeSection: React.FC = () => {
  ...
  const scale = useTransform(scrollYProgress, [0, 0.05, 0.2, 0.7, 1], [0, 0.8, 1, 1, 0]);

  // opacidade de todas as imagens
  const imgOpacity = useTransform(scrollYProgress, [0.25, 0.3, 0.7, 0.8, 1], [0, 1, 1, 1, 0]);
  ...
  const img0y = useTransform(scrollYProgress, obj.imgDelta, [-100, -100, 0, 5, -20]);
  const img0rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, 5, 5, 5]);

  // imagem do meio esquerdo
  const img1x = useTransform(scrollYProgress, obj.imgDelta, obj.imgXLeft);
  const img1y = useTransform(scrollYProgress, obj.imgDelta, [25, 25, 0, 0, -50]);
  const img1rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, 1, 1, 1]);

  // imagem inferior esquerdo
  const img2x = useTransform(scrollYProgress, obj.imgDelta, obj.imgXLeft);
  const img2y = useTransform(scrollYProgress, obj.imgDelta, [100, 100, 0, -10, -100]);
  const img2rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, -5, -5, -5]);

  // imagem superior direito
  const img3x = useTransform(scrollYProgress, obj.imgDelta, obj.imgXRight);
  const img3y = useTransform(scrollYProgress, obj.imgDelta, [-100, -100, 30, 35, 30]);
  const img3rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, -5, -5, -5]);

  // imagem do meio direito
  const img4x = useTransform(scrollYProgress, obj.imgDelta, obj.imgXRight);
  const img4y = useTransform(scrollYProgress, obj.imgDelta, [-50, -50, 20, 20, -30]);
  const img4rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, -1, -1, -1]);

  // imagem inferior direito
  const img5x = useTransform(scrollYProgress, obj.imgDelta, obj.imgXRight);
  const img5y = useTransform(scrollYProgress, obj.imgDelta, [100, 100, 0, -10, -100]);
  const img5rotate = useTransform(scrollYProgress, obj.imgDelta, [0, 0, 5, 5, 5]);
        ...
        <motion.div
          ...
          <div className='flex flex-col md:flex-row justify-center items-center p-12 pb-0 md:gap-32'>
            <motion.div
              ...
              className='w-48 h-48 mb-4 md:hidden'>
          ...
          <motion.img src={devlearnImage0}
            ...
            animate={controls0}
            style={{ x: img0x, y: img0y, rotate: img0rotate, opacity: imgOpacity }}
            className='fixed top-10 left-12 w-1/5 hidden md:block' />
          ...
          <motion.img src={devlearnImage1}
            ...
            animate={controls1}
            style={{ x: img1x, y: img1y, rotate: img1rotate, opacity: imgOpacity }}
            className='fixed top-1/3 w-1/5 hidden md:block' />
          ...
          <motion.img src={hackfoolsImage0}
            ...
            animate={controls2}
            style={{ x: img2x, y: img2y, rotate: img2rotate, opacity: imgOpacity }}
            className='fixed top-2/3 left-12 w-1/5 hidden md:block' />
          ...
          <motion.img src={hackfoolsImage1}
            ...
            animate={controls3}
            style={{ x: img3x, y: img3y, rotate: img3rotate, opacity: imgOpacity }}
            className='fixed top-0 right-12 w-1/5 hidden md:block' />
          ...
          <motion.img src={hackfoolsImage2}
            ...
            animate={controls4}
            style={{ x: img4x, y: img4y, rotate: img4rotate, opacity: imgOpacity }}
            className='fixed top-1/3 right-0 w-1/5 hidden md:block' />
          ...
          <motion.img src={hackfoolsImage3}
            ...
            animate={controls5}
            style={{ x: img5x, y: img5y, rotate: img5rotate, opacity: imgOpacity }}
            className='fixed top-2/3 right-12 w-1/5 hidden md:block' />
